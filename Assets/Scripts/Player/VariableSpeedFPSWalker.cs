...
class VariableSpeedFPSWalker : MonoBehaviour
{
    ...
    private void RigidbodyMovement()
    {
        ...
        Vector3 tubeFinalVector = transform.TransformDirection(new Vector3(horizontal, rigidbody.linearVelocity.y, vertical));

        // Step 4: Apply the final movement in world space
        rigidbody.linearVelocity = tubeFinalVector;
    }
